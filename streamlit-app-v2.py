...
def main():
    ...
    if st.session_state.analysis_complete:
        ...
        tab1, tab2, tab3, tab4 = st.tabs(["Summary", "Root Cause Analysis", "Recommendations", "Timeline"])
            ...
            if 'rootcause' in context_data and context_data['rootcause']:
                ...
                if parsed_rca:
                    ...
                    if 'rationale' in parsed_rca:
                        ...
                        # timeline_plot = create_timeline(transcript_content)
        ...
        # if 'status' in context_data['status'].lower() != 'resolved':
        with tab3:
